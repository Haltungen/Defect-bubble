function [root, fRoot, iIter, iterRoots] = MullersMethod(f, z0, z1, z2, iterMax, distTol, fTol, radius, nPoints)
% MullersMethod
%
% Overview:
...
% --------------------------------------------------
f0 = feval(f, z0, radius, nPoints);
f1 = feval(f, z1, radius, nPoints);
f2 = feval(f, z2, radius, nPoints);
