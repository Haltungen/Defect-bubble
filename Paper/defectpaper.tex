...
\end{prop}
\begin{proof}
\marginpar{\footnotesize Add more details! Asymptotic expansion in $k$}
...
\end{equation*}
is valid for $x\neq y$. It follows that \marginpar{\footnotesize Split into integral with $y$ away from $x$ and $y$ close to $x$.}
\begin{equation*}
